...
# Напишите базовый класс “Человек” (имя, возраст, пол) и его подклассы “Преподаватель” (предмет, стаж) и “Студент” (название специальности,
...
# Напишите базовый класс “Фигура” (длина стороны, количество сторон) который считает периметр. Этот класс наследуют три других: треугольник,
...
# Напишите класс, представляющий собой записную книжку. Каждый элемент записной книжки должен содержать следующие поля: ФИО, но­мер телефона,
